...
function AdminDashboard() {
  ...
  const fetchPengajuan = async () => {
    ...
    if (filterStatus !== 'Semua') query = query.eq('status_akhir', filterStatus);
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="filter">
        ...
        <input type="text" placeholder="Cari nama atau nomor KK..." value={pencarian} onChange={(e) => setPencarian(e.target.value)} />
      </div>
